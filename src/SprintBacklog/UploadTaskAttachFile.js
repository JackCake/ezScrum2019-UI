...
class UploadTaskAttachFile extends React.Component{
    constructor(props){
        super(props);
    ...
    submitAttachFile(){
        ...
        axios.post(Config.back_end_host + Config.ezScrum_api + '/tasks/' + this.props.task.taskId + '/task_attach_files', formData)
            ...
            <div>
                ...
                <Modal show={this.state.show} onHide={this.handleClose}>
                    <Modal.Header closeButton>
                        <Modal.Title>Upload Attach File To Task</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form horizontal>
                            <FormGroup>
...
export default UploadTaskAttachFile;