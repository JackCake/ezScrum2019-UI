...
class SprintBacklog extends React.Component {
  ...
  getStoryBurndownChart(selectedSprintId){
    let self =this;
    axios.get(Config.back_end_host + Config.ezScrum_api + '/products/' + this.props.location.state.selectedProduct.productId + '/sprints/' + selectedSprintId + '/backlog_item_burndown_chart')
    .then(function (response) {
  ...
  getTaskBurndownChart(selectedSprintId){
    let self =this;
    axios.get(Config.back_end_host + Config.ezScrum_api + '/products/' + this.props.location.state.selectedProduct.productId + '/sprints/' + selectedSprintId + '/task_burndown_chart')
    .then(function (response) {
        let realPoints = response.data.realPoints;
        let idealPoints = response.data.idealPoints;
        let sprintDates = response.data.sprintDates;
  ...
  getAllCommittedBacklogItem(selectedSprintId){
    let self = this;
    axios.get(Config.back_end_host + Config.ezScrum_api + '/products/' + this.props.location.state.selectedProduct.productId + '/sprints/' + selectedSprintId + '/committed_backlog_items')
    .then(function (response) {
  ...
  getAllTask(backlogItemId){
    let self =this;
    axios.get(Config.back_end_host + Config.ezScrum_api + '/committed_backlog_items/' + backlogItemId + '/tasks')
    .then(function (response) {
        ...
        <div className="SideBar_Div_Main">
          <div>
            <div style = {{display : 'flex'}}>
              ...
              <PrintCommittedBacklogItem storyData={this.state.storyData} selectedSprintId={this.state.selectedSprintId} selectedProduct={this.props.location.state.selectedProduct}/>
              <PrintTask taskData={this.state.taskData} selectedSprintId={this.state.selectedSprintId} selectedProduct={this.props.location.state.selectedProduct}/>
