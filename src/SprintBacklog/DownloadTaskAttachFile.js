...
class DownloadTaskAttachFile extends React.Component{
    constructor(props){
        super(props);
    ...
    downloadAttachFile(){
        let self = this;
        axios.get(Config.back_end_host + Config.ezScrum_api + '/tasks/' + this.props.attachFile.taskId + '/task_attach_files/' + this.props.attachFile.taskAttachFileId)
...
export default DownloadTaskAttachFile;