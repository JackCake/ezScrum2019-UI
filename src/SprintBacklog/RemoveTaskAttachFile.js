...
class RemoveTaskAttachFile extends React.Component{
    constructor(props){
        super(props);
    ...
    submitAttachFile(){
        let self = this;
        axios.delete(Config.back_end_host + Config.ezScrum_api + '/tasks/' + this.props.attachFile.taskId + '/task_attach_files/' + this.props.attachFile.taskAttachFileId)
            ...
            <span>
                ...
                <Modal show={this.state.show} onHide={this.handleClose}>
                    <Modal.Header closeButton>
                        <Modal.Title>Delete Attach File Of Task</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form horizontal>
...
export default RemoveTaskAttachFile;